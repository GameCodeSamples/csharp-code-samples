Service class that provides methods for loading and instantiating assets from Addressable Assets, a Unity package that provides an alternative to the traditional asset loading system in Unity.
